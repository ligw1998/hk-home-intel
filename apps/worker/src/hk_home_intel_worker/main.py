        ...
        json.dumps(
            {
                ...
                "development_missing_coordinates_count": summary.development_missing_coordinates_count,
                "duplicate_development_name_group_count": summary.duplicate_development_name_group_count,
                "active_listing_missing_price_count": summary.active_listing_missing_price_count,
                "commercial_canonical_with_official_artifact_count": summary.commercial_canonical_with_official_artifact_count,
